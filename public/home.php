...
<head>
	...
	<meta property="og:site_name" content="<?php echo $this->fcSystem['homepage_brandname'];?>" />
	<meta property="fb:admins" content="<?php echo $this->fcSystem['script_admin_id'];?>"/>
	<meta property="fb:app_id" content="<?php echo $this->fcSystem['script_app_id'];?>" />
	...
	<script>
	  (adsbygoogle = window.adsbygoogle || []).push({
	    google_ad_client: "ca-pub-5763383823158310",
...
<script>(function(d, s, id) {
	...
	js.src = "//connect.facebook.net/vi_VN/sdk.js#xfbml=1&version=v2.7&appId=<?php echo $this->fcSystem['script_app_id']; ?>";
